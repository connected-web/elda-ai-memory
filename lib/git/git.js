...
function configure(config) {
  ...
  git.freshCheckout = function() {
    ...
    function configureLineEndings() {
      return git.configure('core.safecrlf', false);
    }
  ...
  git.commit = function(message) {
    ...
    var commitCommand = `cd ${local} && git add . -f && git commit -am "${message}"`;
